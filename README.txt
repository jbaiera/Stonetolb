...
What it currently is (P for planned milestones):
    ...
    Stonetolb 0.0.4 (P) :  Refactoring into Game Modules
    Stonetolb 0.0.5 (P) :  Add a Module Stack to hold modules
    Stonetolb 0.0.6 (P) :  Add ModuleResult objects to pass state results
    Stonetolb 0.0.7 (P) :  Add some sort of Sound managing system
